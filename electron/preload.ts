...
contextBridge.exposeInMainWorld("api", {
  ...
  pokedexMark: (id: string, state: "seen" | "caught" | null) => ipcRenderer.invoke("pokedex-mark", id, state),
  ...
  poke5eReloadPane: () => ipcRenderer.invoke("poke5e-reload-pane"),
  poke5eHiddenGet: () => ipcRenderer.invoke("poke5e-hidden-get"),
  poke5eHiddenSet: (id: string, hidden: boolean) => ipcRenderer.invoke("poke5e-hidden-set", id, hidden),
